...
from Backend.app.api.tag import APITag
from Backend.app.core.exceptions import NothingToUpdate
from Backend.app.core.security import TokenData
from Backend.app.database.redis import add_jti_to_blacklist
from Backend.app.utils import TEMPLATE_DIR
from Backend.app.config import app_settings
from Backend.app.api.schemas.shipment import ShipmentRead
...
async def reset_password(
    ...
    return templates.TemplateResponse(
        ...
        context={
            "login_url": f"{app_settings.FRONTEND_URL}{router.prefix}/login",
            "forgot_url": f"{app_settings.FRONTEND_URL}{router.prefix}/forgot-password",
        }
    )
