...
from Backend.app.api.schemas.delivery_partner import DeliveryPartnerCreate
from Backend.app.core.exceptions import DeliveryPartnerNotAvailable
from Backend.app.database.models import DeliveryPartner, Location, Shipment
